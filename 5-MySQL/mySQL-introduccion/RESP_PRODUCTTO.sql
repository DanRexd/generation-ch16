...
-- -----------------------------------------------------
-- Table `ejemplo_producto`.`CLILIENTE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ejemplo_producto`.`CLILIENTE` ;

CREATE TABLE IF NOT EXISTS `ejemplo_producto`.`CLILIENTE` (
...
CREATE TABLE IF NOT EXISTS `ejemplo_producto`.`COMPRA` (
  `CLILIENTE_dni` INT NOT NULL,
  `PRODUCTO_codigo` INT NOT NULL,
  PRIMARY KEY (`CLILIENTE_dni`, `PRODUCTO_codigo`),
  INDEX `fk_CLILIENTE_has_PRODUCTO_PRODUCTO1_idx` (`PRODUCTO_codigo` ASC) VISIBLE,
  INDEX `fk_CLILIENTE_has_PRODUCTO_CLILIENTE_idx` (`CLILIENTE_dni` ASC) VISIBLE,
  CONSTRAINT `fk_CLILIENTE_has_PRODUCTO_CLILIENTE`
    FOREIGN KEY (`CLILIENTE_dni`)
    REFERENCES `ejemplo_producto`.`CLILIENTE` (`dni`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CLILIENTE_has_PRODUCTO_PRODUCTO1`
